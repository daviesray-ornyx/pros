    ...
    $('#form_login').submit(function (event) {
        ...
        $.ajax({
            ...
            success: function (data) {
                window.location = '/'; // Navigate to login
            },
            error:function (xhr, errmsg, err) {
                alert("Error logging in!"); // Show login alert
            }
        })
    });
}

function init_getMatches() {


    $('.get_matches').click(function (event) {
        var item = $(this);
        var leagueId = item.data('league_id')
        alert("Trying to get specific league matches!!:- " + leagueId);

        $.ajax({
            url: '/ajax/?league_id=' + leagueId,
            type: 'GET',
            dataType: 'json',
            data: '',
            success: function (data) {
